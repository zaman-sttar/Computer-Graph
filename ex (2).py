...
george.forward(61)
george.right(100)
george.forward(160 / math.sqrt(2))
...
def flower(x, y, color, color1, z, w):
 ...
 for i in range(25):
  ...
  f.circle(z, w)
  f.end_fill()
flower(660, -30, "olivedrab", "red", 30, 30)
flower(630, -30, "olivedrab", "yellow", 30, 30)
flower(600, -30, "olivedrab", "pink", 30, 30)
flower(570, -30, "olivedrab", "orange", 30, 30)
flower(450, -30, "olivedrab", "red", 30, 30)
flower(420, -30, "olivedrab", "pink", 30, 30)
flower(390, -30, "olivedrab", "yellow", 30, 30)
flower(350, -30, "olivedrab", "orange", 30, 30)
r.hideturtle()
t.hideturtle()
m.hideturtle()
pen.hideturtle()
